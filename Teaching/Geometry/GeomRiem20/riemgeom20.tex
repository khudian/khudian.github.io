%It is a new course. I began this document on 31-st January 2010.nother 
...
% I began it on 1 February 2020 and do some 
%changings
   ...
   Domain in Lobachevsky plane.
    ...
    Consider in Lobachevsky plane the domain $D_a$ such that
          ...
          {triangleinlobachevskyplane}
               D_a=\{x,y\colon \quad   x^2+y^2\geq 1, |x|\leq a\}\,, 
                 (|a|\leq 1)\,.
                            \end{equation}
 {\bf Remark} Note that vertical lines and half-circle are geodesics.
   One can see that the distance between these lines 
tends to zero\footnote(see the coursework).
    If we 
...
form on Lobachevsky plane
        ...
        V(D_a)=\int_{-a\leq y\leq a\,, x^2+y^2\geq 1}{dxdy\over y^2}=
                  2\arcsin{a}
                   \end{equation}
(See in detail Homework and coursework)
