...
\maketitle
  ...
  \centerline { Manchester, 2  February,  2019}
...
We use in all formulae Einstein summation rules.
...
Now recall what is $1$-form
 
             Consider cotangent space $T^*_\pt M$
(for every point $\pt$ on manifold $M$)---
    space of linear functions on tangent vectors, i.e. space of $1$-forms which sometimes are called
         ...
         One-form (covector) $\w=\w_i(x)dx^i$ 
